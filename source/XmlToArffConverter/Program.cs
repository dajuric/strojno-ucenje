...
namespace XmlToArffConverter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            XmlParser xmlReaderLearn = new XmlParser(learnSet + ".xml", windowsSize, windowsSize);          
            Console.WriteLine("Reading XML ...");
            xmlReaderLearn.Parse();

            ArffWriter arffWriterLearn = new ArffWriter(xmlReaderLearn, learnSet + ".arff"); 
            ...
            XmlParser xmlReaderTrain = new XmlParser(trainSet + ".xml", windowsSize, windowsSize); 
            Console.WriteLine("Reading XML ...");
            xmlReaderTrain.Parse();

            ArffWriter arffWriterTrain = new ArffWriter(xmlReaderTrain, trainSet + ".arff");
