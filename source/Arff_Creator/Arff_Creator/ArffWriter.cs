...
namespace Arff_Creator
{
    public class ArffWriter:IDisposable
    {
        ...
        {
            public static readonly string[] DEFAULT_VALUES = new string[] { "T", "F" };
        ...
        {
            Attribute[] sortedAttributes = new Attribute[dicAttributes.Count + 1]; //+1 za definicijski atribut
            ...
            sortedAttributes[sortedAttributes.Length - 1] = new Attribute("definition", dictKeys); //definicijski atribut
